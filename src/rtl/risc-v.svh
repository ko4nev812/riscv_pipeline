...
localparam int IMEM_ADDR_WIDTH = 6;                  // (byte addressed) CPU system implementation dependent
localparam int DMEM_ADDR_WIDTH = 6;                  // (byte addressed) CPU system implementation dependent
